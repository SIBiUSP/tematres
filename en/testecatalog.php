...
<!-- Scripts USP -->
    <script type="application/javascript" src="testejs.php" charset="utf-8"></script>
...
<form name="construtor">    
	<div class="panel-body">
		...
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" id="profissoesresposta" placeholder="Profissões e ocupações" data-dprofissoesresposta="" onblur="if(this.value!=this.dataset['dprofissoesresposta']) this.value='';">
		</div>
